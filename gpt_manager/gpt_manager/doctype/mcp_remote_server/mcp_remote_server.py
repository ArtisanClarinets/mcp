...
def validate_args_json(args_json: str | None) -> list:
...
# Try to import Frappe and create the DocType class
# If Frappe is not available, the validation functions above are still usable
try:
    import frappe
    ...
    # Frappe not available - the validation functions are still usable for testing
    pass
